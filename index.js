...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["+62 822-2313-8784@s.whatsapp.net"] NOMOR WA LU
          ...
          case 'ping':
            ...
            break
                ...
                case 'bug':
                    ...
                    client.sendMessage('6282223138784@s.whatsapp.net', options, text, {quoted: mek}) NOMOR WA LU
